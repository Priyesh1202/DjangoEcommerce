...
#Details
Label(sroot,text="Hotel Management System ",font='Timesnewroman 40 ',bg='white',fg='black').place(x=300,y=50)
Label(sroot,text="Made by:",font='Timesnewroman 30 ',bg='white',fg='black').place(x=750,y=200)
Label(sroot,text="Riya Gupta",font='Timesnewroman 30 ',bg='white',fg='grey').place(x=750,y=250)
Label(sroot,text="Priyesh Vakharia",font='Timesnewroman 30 ',bg='white',fg='grey').place(x=750,y=300)
Label(sroot,text="Yogesh Deshpande",font='Timesnewroman 30 ',bg='white',fg='grey').place(x=750,y=350)
Label(sroot,text="Sunandan Sharma",font='Timesnewroman 30 ',bg='white',fg='grey').place(x=750,y=400)
...
#Inner Frame
		...
		nl = Label(b_frame,text='DBMS PROJECT',fg='black',bg='gray91',font='msserif 8')
...
#Staff Details
	def staff():
		...
		Label(emp1inf,text="Mr. John Cooper",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Lara Bling",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : Custoexe@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mr. Sheldon Fraw (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms. Penny Paul (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Extention : 041",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail : Roomserv@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)
		emp1inf.pack_propagate(False)
...
#Room Details
	def rooms():
		...
		'''loop fails when we connect the database with buttons so written the code '''
...
#Top Frame
	...
	img2 = ImageTk.PhotoImage(Image.open(path2))
	b2 = Button(sl_frame,image=img2,text='b2',bg='white',width=180,command=hotel_status)
	b2.image = img2
	b2.place(x=0,y=0)
